...
std::string	command::botList(client &c){
	...
	info += ":localhost " + helper::itos(321) + " " + c.getnickName() + " HELP :List of all the commands available in the server\n";
	info += ":localhost " + helper::itos(321) + " " + c.getnickName() + " SESS :The time you spend on the server\n";
	info += ":localhost " + helper::itos(321) + " " + c.getnickName() + " CHECKNICK :Check if a given nick name is free\n";
	info += ":localhost " + helper::itos(321) + " " + c.getnickName() + " FAV :Add a favorite list of friends\n";
